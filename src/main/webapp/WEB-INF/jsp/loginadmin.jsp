            ...
            <div class="layadmin-user-login-main">
                ...
                <form id="login-" class="layui-form">
                    <div class="demo-login-container">
                        ...
                        <div class="layui-form-item">
                            <a href="regadmin" style="float: right; margin-top: 7px;">注册</a>
                        </div>
                        <%--                <div class="layui-form-item">--%>
                        <%--                    <div class="layui-row">--%>
                        ...
                        <div class="layui-form-item">
                            <button id="demo0" class="layui-btn layui-btn-fluid" lay-submit lay-filter="demo-login">
                                登录
                            </button>
                        </div>
