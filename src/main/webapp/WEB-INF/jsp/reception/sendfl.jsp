...
<html>
    ...
    <body>
        <div class="layui-col-md5 layui-col-md-offset4" style="margin-top: 100px;">
            <form class="layui-form" action="fledit${id}" method="post" enctype="multipart/form-data">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <c:otherwise>
                                ...
                                style="width: 200px;" type="text"  lay-verify="required"
                                placeholder="请输入"
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline layui-input-wrap">
                            ...
                            <c:otherwise>
                                    ...
                                    id="address" type="text" value="" name="address" lay-verify="required"
                                    autocomplete="off"
                                    class="layui-input">
                        </div>
                        <div class="layui-form-mid" style="padding: 0!important;">
                            <button id="getadress" type="button" class="layui-btn layui-btn-primary">地点获取</button>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <c:otherwise>
                                ...
                                id="date" style="width: 200px;" type="text"  lay-verify="required"
                                placeholder="请输入"
                                autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <label class="layui-form-label">具体详情</label>
                    <div class="layui-input-block">
                        <textarea name="detail" style="width: 400px;" placeholder="请输入内容"
